// import * as prop from './reactbank-env.json';
...
const prop = require('./reactbank-env.json');
...
const landingPageUrl = prop.GOOD_REACTBANK_LANDING_PAGE_URL;
const landingLoginButtonXPath = "//a[@class='btn btn-primary btn-lg' and " +
      "contains(text(),'Click here to log in')]";

const loginEmailAddr = prop.REACTBANK_USERNAME;
const loginPassword = prop.REACTBANK_PASSWORD;
...
const helpFormItems = {
  name: prop.REACTBANK_COMPLAINT_FULLNAME,
  email: prop.REACTBANK_COMPLAINT_EMAIL,
  homePhone: "1-555-650-5555",
  officePhone: "1-555-440-5555",
  mobilePhone: "1-555-240-5555",
  message: prop.REACTBANK_COMPLAINT_MESSAGE
};
